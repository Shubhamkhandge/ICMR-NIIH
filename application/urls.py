...
urlpatterns = [
    ...
    path('admin_dashboard/update_department', views.update_department, name='update_department'),
    path('admin_dashboard/all_scientists', views.all_scientists, name='all_scientists'),
    path('admin_dashboard/add_scientist', views.add_scientist, name='add_scientist'),
